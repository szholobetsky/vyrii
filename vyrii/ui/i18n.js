const I18N = {
  en: {
    ...
    // Role
    role: 'Role', tab_role: 'Role',
    role_desc: 'Named system prompts chosen once at the start of a new chat — stay invisible for the rest of it. Distinct from Prompts, which are inserted manually.',
    role_add: 'Add role', role_name: 'Name', role_size: 'Reserved size (tokens)',
    role_prompt: 'System prompt', role_add_btn: 'Save', role_none: 'No roles yet',
    role_edit_btn: 'Edit', role_active_label: '🎭 Role: {name}',
    role_empty: 'No roles yet — create one in the Role tab',
    role_tok_count: '~{n} tokens', role_tok_count_cap: '~{n} / {cap} tokens',
    role_badge_actual_title: 'actual prompt size', role_badge_reserved_title: 'declared reserved size',
    role_badge_reserved: 'reserved {n}',
    role_warn_cut: 'Role "{name}" is ~{actual} tokens but autocut\'s "first" budget is only {first} — it may get cut mid-chat. Raise autocut_first in Settings or shorten the role.',
  },
  uk: {
    ...
    tab_glossary: 'Глосарій',
    tab_simargl: 'Симаргл', simargl_desc: 'Пошук коду за задачею — проіндексуйте проект і шукайте за описом задачі.',
    ...
    tab_svitovyd: 'Світовид', svitovyd_desc: 'Карта проекту — проіндексуйте структуру коду, потім знаходьте/відстежуйте.',
    ...
    // Role
    role: 'Роль', tab_role: 'Роль',
    role_desc: 'Іменовані системні промпти, обрані один раз на старті нового чату — лишаються невидимими до кінця чату. На відміну від Промптів, які вставляються вручну.',
    role_add: 'Додати роль', role_name: 'Назва', role_size: 'Зарезервований розмір (токени)',
    role_prompt: 'Системний промпт', role_add_btn: 'Зберегти', role_none: 'Ролей ще немає',
    role_edit_btn: 'Редагувати', role_active_label: '🎭 Роль: {name}',
    role_empty: 'Ролей ще немає — створіть у вкладці Роль',
    role_tok_count: '~{n} токенів', role_tok_count_cap: '~{n} / {cap} токенів',
    role_badge_actual_title: 'фактичний розмір промпту', role_badge_reserved_title: 'заявлений зарезервований розмір',
    role_badge_reserved: 'резерв {n}',
    role_warn_cut: 'Роль "{name}" займає ~{actual} токенів, а бюджет autocut "first" — лише {first} — її може вирізати посеред чату. Збільшіть autocut_first у Налаштуваннях або скоротіть роль.',
  },
  de: {
    ...
    // Role
    role: 'Rolle', tab_role: 'Rolle',
    role_desc: 'Benannte System-Prompts, die einmal zu Beginn eines neuen Chats ausgewählt werden — bleiben für den Rest unsichtbar. Im Unterschied zu Prompts, die manuell eingefügt werden.',
    role_add: 'Rolle hinzufügen', role_name: 'Name', role_size: 'Reservierte Größe (Token)',
    role_prompt: 'System-Prompt', role_add_btn: 'Speichern', role_none: 'Noch keine Rollen',
    role_edit_btn: 'Bearbeiten', role_active_label: '🎭 Rolle: {name}',
    role_empty: 'Noch keine Rollen — erstelle eine im Rolle-Tab',
    role_tok_count: '~{n} Token', role_tok_count_cap: '~{n} / {cap} Token',
    role_badge_actual_title: 'tatsächliche Prompt-Größe', role_badge_reserved_title: 'angegebene reservierte Größe',
    role_badge_reserved: 'reserviert {n}',
    role_warn_cut: 'Rolle "{name}" hat ~{actual} Token, aber das Autocut-"first"-Budget beträgt nur {first} — sie könnte mitten im Chat abgeschnitten werden. Erhöhe autocut_first in den Einstellungen oder kürze die Rolle.',
  },
  fr: {
    ...
    // Role
    role: 'Rôle', tab_role: 'Rôle',
    role_desc: 'Prompts système nommés, choisis une fois au début d\'une nouvelle conversation — restent invisibles pour le reste. Contrairement aux Prompts, insérés manuellement.',
    role_add: 'Ajouter un rôle', role_name: 'Nom', role_size: 'Taille réservée (jetons)',
    role_prompt: 'Prompt système', role_add_btn: 'Enregistrer', role_none: 'Aucun rôle encore',
    role_edit_btn: 'Modifier', role_active_label: '🎭 Rôle : {name}',
    role_empty: 'Aucun rôle encore — créez-en un dans l\'onglet Rôle',
    role_tok_count: '~{n} jetons', role_tok_count_cap: '~{n} / {cap} jetons',
    role_badge_actual_title: 'taille réelle du prompt', role_badge_reserved_title: 'taille réservée déclarée',
    role_badge_reserved: 'réservé {n}',
    role_warn_cut: 'Le rôle "{name}" fait ~{actual} jetons mais le budget "first" d\'autocut n\'est que de {first} — il risque d\'être coupé en cours de conversation. Augmentez autocut_first dans les Paramètres ou raccourcissez le rôle.',
  },
  es: {
    ...
    // Role
    role: 'Rol', tab_role: 'Rol',
    role_desc: 'Prompts de sistema con nombre, elegidos una vez al inicio de un nuevo chat — permanecen invisibles el resto del chat. A diferencia de los Prompts, que se insertan manualmente.',
    role_add: 'Añadir rol', role_name: 'Nombre', role_size: 'Tamaño reservado (tokens)',
    role_prompt: 'Prompt de sistema', role_add_btn: 'Guardar', role_none: 'Aún no hay roles',
    role_edit_btn: 'Editar', role_active_label: '🎭 Rol: {name}',
    role_empty: 'Aún no hay roles — crea uno en la pestaña Rol',
    role_tok_count: '~{n} tokens', role_tok_count_cap: '~{n} / {cap} tokens',
    role_badge_actual_title: 'tamaño real del prompt', role_badge_reserved_title: 'tamaño reservado declarado',
    role_badge_reserved: 'reservado {n}',
    role_warn_cut: 'El rol "{name}" tiene ~{actual} tokens pero el presupuesto "first" de autocut es solo {first} — podría cortarse a mitad del chat. Aumenta autocut_first en Ajustes o acorta el rol.',
  },
  pt: {
    ...
    // Role
    role: 'Papel', tab_role: 'Papel',
    role_desc: 'Prompts de sistema nomeados, escolhidos uma vez no início de uma nova conversa — permanecem invisíveis pelo resto dela. Diferente dos Prompts, que são inseridos manualmente.',
    role_add: 'Adicionar papel', role_name: 'Nome', role_size: 'Tamanho reservado (tokens)',
    role_prompt: 'Prompt de sistema', role_add_btn: 'Salvar', role_none: 'Nenhum papel ainda',
    role_edit_btn: 'Editar', role_active_label: '🎭 Papel: {name}',
    role_empty: 'Nenhum papel ainda — crie um na aba Papel',
    role_tok_count: '~{n} tokens', role_tok_count_cap: '~{n} / {cap} tokens',
    role_badge_actual_title: 'tamanho real do prompt', role_badge_reserved_title: 'tamanho reservado declarado',
    role_badge_reserved: 'reservado {n}',
    role_warn_cut: 'O papel "{name}" tem ~{actual} tokens, mas o orçamento "first" do autocut é de apenas {first} — pode ser cortado no meio da conversa. Aumente autocut_first em Configurações ou reduza o papel.',
  },
};
